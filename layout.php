...
<body ng-controller="migrationGeneratorController">
    ...
    <div id="container">
        ...
        <form id="migrationForm">
            ...
            <input type="text" id="tableName" name="tableName" ng-model="tableName" required><br><br>

            <label for="softDeleteCheckbox">
                <input type="checkbox" id="softDeleteCheckbox" ng-model="softDelete"> Soft Delete
            </label><br><br>
            ...
            <table>
                ...
                <tbody>
                    <tr ng-repeat="column in columns track by $index">
                        <td><input type="text" class="columnName" ng-model="columns[$index].name" required></td>
                        <td>
                            <select class="columnType" ng-model="columns[$index].type" required>
                                <option value="">Selecione o Tipo</option>
                                <option ng-repeat="type in columnTypes" value="{{ type }}">{{ type }}</option>
                            </select>
                        </td>
                        <td><input type="text" ng-model="columns[$index].defaultValue"></td>
                        <td><input type="checkbox" ng-model="columns[$index].required"></td>
